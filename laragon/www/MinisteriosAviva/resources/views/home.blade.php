        ...
        <div class="row">
            ...
            <main class="main-content col">
                ...
                <div id="contenido" class="p-3">
                    ...
                    <div id="componentes" class="seccion-oculta">
                        <h2>Componentes</h2>
                        <p>Aquí puedes ver los componentes disponibles.</p>
                    </div>
                    <div id="tablas" class="seccion-oculta">
                        <h2>Tablas</h2>
                        <p>Aquí puedes ver las tablas.</p>
                    </div>
